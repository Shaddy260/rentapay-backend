// src/constants/kenyaConstituencies.js
//
// The 290 constituencies of Kenya, grouped by county (county names match
// KENYA_COUNTIES in ./kenyaCounties.js exactly - used as the lookup key).
// Added alongside county for landlord setup: same reasoning as county
// existing at all - a fixed dropdown instead of free text, so the
// value is reliable enough for Phase 5's vacancy filtering and any
// future admin breakdowns to depend on.
const KENYA_CONSTITUENCIES = {
  ...
  'Murang\'a': ['Kangema', 'Mathioya', 'Kiharu', 'Kigumo', 'Kandara', 'Gatanga', 'Maragwa'],
...
module.exports = { KENYA_CONSTITUENCIES };
