...
async function getActorDisplay(req) {
  ...
  try {
    ...
    logger.error('[announcements] getActorDisplay error:', err.message);
...
async function fanOutAnnouncementPush(announcement) {
  try {
    ...
    logger.error('[announcements] fanOutAnnouncementPush error:', err.message);
    captureException(err);
  }
}
...
async function createAnnouncement(req, res) {
  try {
    ...
    if (await blockIfSubscriptionExpired(req, res, landlordId, audience === 'property' ? propertyId : null)) return;
    ...
    logger.error('[announcements] createAnnouncement error:', err.message);
    captureException(err);
...
async function createPlatformAnnouncement(req, res) {
  try {
    ...
    logger.error('[announcements] createPlatformAnnouncement error:', err.message);
    captureException(err);
...
async function postSystemAnnouncement(landlordId, message, options = {}) {
  try {
    ...
    logger.error('[announcements] postSystemAnnouncement error:', err.message);
    captureException(err);
...
async function listAnnouncements(req, res) {
  try {
    ...
    const activePropertyId = role !== 'tenant' ? req.query.propertyId : null;
    ...
    logger.error('[announcements] listAnnouncements error:', err.message);
    captureException(err);
...
async function markAnnouncementRead(req, res) {
  try {
    ...
    logger.error('[announcements] markAnnouncementRead error:', err.message);
    captureException(err);
...
async function deleteAnnouncement(req, res) {
  try {
    ...
    logger.error('[announcements] deleteAnnouncement error:', err.message);
    captureException(err);
