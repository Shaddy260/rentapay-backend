...
async function listExpenses(req, res) {
  try {
    ...
    logger.error('[expense] listExpenses error:', err.message);
...
async function createExpense(req, res) {
  try {
    ...
    logger.error('[expense] createExpense error:', err.message);
    captureException(err);
...
async function updateExpense(req, res) {
  try {
    ...
    logger.error('[expense] updateExpense error:', err.message);
    captureException(err);
...
async function deleteExpense(req, res) {
  try {
    ...
    logger.error('[expense] deleteExpense error:', err.message);
    captureException(err);
