...
function recipientFor(req) {
  ...
  // FIX: admin used to fall through to the landlord default below -
...
async function listNotifications(req, res) {
  try {
    ...
    logger.error('[notifications] listNotifications error:', err.message);
...
async function markRead(req, res) {
  try {
    ...
    logger.error('[notifications] markRead error:', err.message);
    captureException(err);
...
async function deleteNotification(req, res) {
  try {
    ...
    logger.error('[notifications] deleteNotification error:', err.message);
    captureException(err);
...
async function deleteAllNotifications(req, res) {
  try {
    ...
    logger.error('[notifications] deleteAllNotifications error:', err.message);
    captureException(err);
