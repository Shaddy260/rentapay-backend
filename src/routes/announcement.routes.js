...
router.get('/', requireRole('landlord', 'manager', 'tenant'), announcementController.listAnnouncements);
router.post('/:announcementId/read', requireRole('landlord', 'manager', 'tenant'), announcementController.markAnnouncementRead);
...
router.delete('/:announcementId', requireRole('landlord', 'manager', 'tenant', 'admin'), announcementController.deleteAnnouncement);
