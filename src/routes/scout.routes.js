...
router.put('/my-profile', verifyToken, requireRole('scout'), scoutController.updateMyContact);
...
router.get('/leaderboard', verifyToken, requireRole('scout'), scoutController.getLeaderboard);
router.patch('/referrals/:referralId/stage', verifyToken, requireRole('scout'), scoutController.advanceReferralStage);
