...
router.post('/:tenantId/rate', requireRole('landlord', 'manager'), requireNotCaretaker('Caretakers cannot rate tenants. Contact the landlord or property manager.'), tenantController.rateTenant);
